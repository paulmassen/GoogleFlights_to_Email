...
script1.setAttribute('href', '//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css');
...
script3.src = '//code.jquery.com/jquery-latest.min.js';
document.body.appendChild(script3);

var script2 = document.createElement('script');
script2.src = '//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js';
...
var copyListener = function copyListener(event) {
  var trip = "";
  var tripHTML = ""; // Get all segments

  var segments = $('.gws-flights-results__slice-selection'); // Iterate over each segment
  ...
  segments.each(function (index) {
    ...
    legs.each(function (index) {
      ...
      leg = leg + "🛫 Departure " + departureAirport + " (" + departureIATACode + ") " + departureDate.toLocaleDateString('fr-FR', {
        'day': '2-digit',
        'month': 'short'
      }) + " " + departureTime + "\r\n";
      leg = leg + "🛬 Arrival " + arrivalAirport + " (" + arrivalIATACode + ") " + arrivalDate.toLocaleDateString('fr-FR', {
        'day': '2-digit',
        'month': 'short'
      }) + " " + arrivalTime + "\r\n";
      var legHTML = "";
      legHTML = legHTML + "<b>" + airline + " " + flightNumber + "</b> (dur: " + travelTime + ")" + "<br/>";
      legHTML = legHTML + "Departure " + departureAirport + " (" + departureIATACode + ") " + departureDate.toLocaleDateString('fr-FR', {
        'day': '2-digit',
        'month': 'short'
      }) + " " + departureTime + "<br/>";
      legHTML = legHTML + "Arrival " + arrivalAirport + " (" + arrivalIATACode + ") " + arrivalDate.toLocaleDateString('fr-FR', {
        'day': '2-digit',
        'month': 'short'
      }) + " " + arrivalTime + "<br/>";
      trip = trip + leg + "\r\n";
